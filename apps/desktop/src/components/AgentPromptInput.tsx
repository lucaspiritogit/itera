...
export function ReviewPromptInput({
  ...
  const modeStyle =
    kind === "ask"
      ? {
          form:
            "border-green-400/50 focus-within:border-green-300 focus-within:ring-green-400/20",
          badge: "border-green-400/40 bg-green-400/10 text-green-100",
          activeTab: "border-green-400 bg-green-400/15 text-green-100",
          textarea:
            "text-green-50 caret-green-300 placeholder:text-green-300/45",
          send: "border-green-400 bg-green-500 enabled:hover:bg-green-400",
        }
      : {
          form:
            "border-orange-400/50 focus-within:border-orange-300 focus-within:ring-orange-400/20",
          badge: "border-orange-400/40 bg-orange-400/10 text-orange-100",
          activeTab: "border-orange-400 bg-orange-400/15 text-orange-100",
          textarea:
            "text-orange-50 caret-orange-300 placeholder:text-orange-300/45",
          send: "border-orange-400 bg-orange-500 enabled:hover:bg-orange-400",
        };
    ...
    >
      ...
      <div className="relative">
        <textarea
          ...
          rows={2}
          className={`box-border max-h-40 min-h-16 w-full resize-none border-0 bg-transparent py-2 pl-2 pr-14 font-[inherit] text-sm leading-relaxed outline-none disabled:opacity-60 ${modeStyle.textarea}`}
        />
        <button
          type="submit"
          disabled={!canSubmit}
          ...
          title="Send"
          className={`absolute bottom-1.5 right-1.5 flex h-9 w-9 items-center justify-center rounded-full border text-white shadow-sm transition enabled:cursor-pointer disabled:cursor-not-allowed disabled:border-neutral-800 disabled:bg-neutral-900 disabled:text-neutral-600 disabled:shadow-none ${modeStyle.send}`}
        >
          <span aria-hidden className="text-base leading-none">
            ↑
          </span>
